...
namespace systemafacturacion.Libreria
{
    public static class ConnectionHelper
    {
        ...
        public const string ConnectionString = @"XpoProvider=MySql;server=localhost;user id=root; password=LINUX1983; database=Libreria;persist security info=true;CharSet=utf8;";
