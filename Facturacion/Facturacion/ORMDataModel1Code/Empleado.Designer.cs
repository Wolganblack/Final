...
namespace Facturacion.facturacion
{
    ...
    public partial class Empleado : XPLiteObject
    {
        ...
        Empleado fIdJefe;
        [Persistent(@"idJefe")]
        [Association(@"EmpleadoReferencesEmpleado")]
        public Empleado IdJefe
        {
            get { return fIdJefe; }
            set { SetPropertyValue<Empleado>(nameof(IdJefe), ref fIdJefe, value); }
        }
        Area fIdArea;
        [Persistent(@"idArea")]
        ...
        {
            get { return fIdArea; }
            set { SetPropertyValue<Area>(nameof(IdArea), ref fIdArea, value); }
        }
        string fTelefono;
        [Size(20)]
        [Persistent(@"telefono")]
        ...
        [Association(@"EmpleadoReferencesEmpleado")]
        public XPCollection<Empleado> EmpleadoCollection { get { return GetCollection<Empleado>(nameof(EmpleadoCollection)); } }
