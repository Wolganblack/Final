...
namespace Prueba.prueba
{
    public static class ConnectionHelper
    {
        ...
        public const string ConnectionString = @"XpoProvider=MySql;server=localhost;user id=root; password=LINUX1983; database=prueba;persist security info=true;CharSet=utf8;";
