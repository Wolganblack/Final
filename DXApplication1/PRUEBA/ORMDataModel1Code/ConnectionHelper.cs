...
namespace PRUEBA.mydb
{
    public static class ConnectionHelper
    {
        ...
        public const string ConnectionString = @"XpoProvider=MySql;server=localhost;user id=root; password=LINUX1983; database=mydb;persist security info=true;CharSet=utf8;";
