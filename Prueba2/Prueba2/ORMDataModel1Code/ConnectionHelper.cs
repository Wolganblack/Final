...
namespace Prueba2.testeo
{
    public static class ConnectionHelper
    {
        ...
        public const string ConnectionString = @"XpoProvider=MySql;server=localhost;user id=root; password=LINUX1983; database=testeo;persist security info=true;CharSet=utf8;";
